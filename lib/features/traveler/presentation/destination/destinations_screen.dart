              ...
              children: [
                ...
                Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      Icon(Icons.navigation_outlined, color: primaryColor, size: 20),
                      SizedBox(width: 8),
                      Text("Cairo Central Station", style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
                    ],
                  ),
                ),
                const SizedBox(height: 24),
                // أيقونة الخريطة
                const Icon(Icons.location_on, color: primaryColor, size: 50),
                const SizedBox(height: 4),
                const Text("Map View", style: TextStyle(color: textColor, fontWeight: FontWeight.w500)),
              ],
            ),
          ),
          ...
          Expanded(
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  const Text("Where are you going?", style: TextStyle(color: textColor, fontSize: 16, fontWeight: FontWeight.bold)),
                  ...
                  const Text("Popular Destinations", style: TextStyle(color: textColor, fontSize: 18, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
